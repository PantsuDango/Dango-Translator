...
# 私人彩云设置界面
class CaiyunSetting(QWidget) :

    def __init__(self, object) :

        super(CaiyunSetting, self).__init__()
        self.object = object
    ...
    def ui(self) :
        ...
        # 窗口标题
        self.setWindowTitle("私人彩云翻译设置 - 退出会自动保存")
        # 窗口图标
        ...
        self.secret_key_text.setText(self.object.config["caiyunAPI"])
        ...
        button.setText("测试")
        button.clicked.connect(lambda: utils.test.testCaiyun(
    ...
    def openTutorial(self) :
        ...
        try :
            ...
            utils.message.MessageBox("私人彩云注册",
                                     "请尝试手动打开此地址:\n%s     " % url)
    ...
    def closeEvent(self, event) :
        ...
        self.object.config["caiyunAPI"] = self.filterNullWord(self.secret_key_text)