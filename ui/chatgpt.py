...
class ChatGPTSetting(QWidget) :
    ...
    def ui(self) :
        ...
        self.customSetGeometry(button, 65, 360, 60, 20)
        button.setText("测试")
        ...
        # 注册按钮
        button = QPushButton(self)
        self.customSetGeometry(button, 155, 360, 60, 20)
        button.setText("注册")
        ...
        # 查额度按钮
        button = QPushButton(self)
        self.customSetGeometry(button, 245, 360, 60, 20)
        button.setText("查额度")
    ...
    def getInitConfig(self) :
        ...
        self.window_height = int(410 * self.rate)
        # 颜色
        self.color = "#5B8FF9"
        # 模型列表
        self.model_list = [
