...
# 私人阿里云设置界面
class AliyunSetting(QWidget) :

    def __init__(self, object) :

        super(AliyunSetting, self).__init__()
        self.object = object
    ...
    def ui(self) :
        ...
        # 窗口标题
        self.setWindowTitle("私人阿里云翻译设置 - 退出会自动保存")
        # 窗口图标
        ...
        button.setText("测试")
        button.clicked.connect(lambda: utils.test.testAliyun(
    ...
    def openTutorial(self) :
        ...
        try :
            ...
            utils.message.MessageBox("私人阿里云注册",
                                     "请尝试手动打开此地址:\n%s     " % url)
    ...
    def openQueryQuota(self):
        ...
        try:
            ...
            self.logger.error(format_exc())
            utils.message.MessageBox("私人阿里云额度查询",
                                     "打开地址失败, 请尝试手动打开此网页下载\n%s     " % url)
    ...
    def closeEvent(self, event) :
        ...
        self.object.config["aliyunAPI"]["Key"] = self.filterNullWord(self.secret_id_text)
        self.object.config["aliyunAPI"]["Secret"] = self.filterNullWord(self.secret_key_text)