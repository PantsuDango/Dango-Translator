...
# 私人腾讯设置界面
class TencentSetting(QWidget) :

    def __init__(self, object) :

        super(TencentSetting, self).__init__()
        self.object = object
    ...
    def ui(self) :
        ...
        # 窗口标题
        self.setWindowTitle("私人腾讯翻译设置 - 退出会自动保存")
        # 窗口图标
        ...
        self.secret_id_text.setText(self.object.config["tencentAPI"]["Key"])
        ...
        self.secret_key_text.setText(self.object.config["tencentAPI"]["Secret"])
        ...
        button.setText("测试")
        button.clicked.connect(lambda: utils.test.testTencent(
    ...
    def openTutorial(self) :
        ...
        try :
            ...
            utils.message.MessageBox("私人腾讯注册",
                                     "请尝试手动打开此地址:\n%s     " % url)
    ...
    def closeEvent(self, event) :
        ...
        self.object.config["tencentAPI"]["Key"] = self.filterNullWord(self.secret_id_text)
        self.object.config["tencentAPI"]["Secret"] = self.filterNullWord(self.secret_key_text)